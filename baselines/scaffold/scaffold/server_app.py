...
from scaffold.utils import instantiate_model_from_string, seed_all
from scaffold.model import get_weights, test
from scaffold.strategy import SCAFFOLD
...
def server_fn(context: Context):
    ...
    strategy = SCAFFOLD(
        ...
        total_num_clients=context.run_config["num-clients"],
